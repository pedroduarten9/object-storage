...
// UuidPath defines model for UuidPath.
type UuidPath = string

// ServerInterface represents all server handlers.
type ServerInterface interface {

	// (GET /object/{uuid})
	GetObject(ctx echo.Context, uuid UuidPath) error

	// (PUT /object/{uuid})
	PutObject(ctx echo.Context, uuid UuidPath) error
}
...
func (w *ServerInterfaceWrapper) GetObject(ctx echo.Context) error {
	...
	err = w.Handler.GetObject(ctx, uuid)
	return err
}
...
func (w *ServerInterfaceWrapper) PutObject(ctx echo.Context) error {
	...
	// Invoke the callback with all the unmarshaled arguments
	err = w.Handler.PutObject(ctx, uuid)
	return err
}
...
func RegisterHandlersWithBaseURL(router EchoRouter, si ServerInterface, baseURL string) {
	...
	router.GET(baseURL+"/object/:uuid", wrapper.GetObject)
	router.PUT(baseURL+"/object/:uuid", wrapper.PutObject)
